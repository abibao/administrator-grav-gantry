...
return [
    ...
    'timestamp' => 1478727944,
    'checksum' => '94a1955cd98e8b7d3a57e833a2f7dbcf',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/google-charts' => [
                'file' => 'user/plugins/google-charts/blueprints.yaml',
                'modified' => 1478695300
            ],
            ...
            'plugins/abibao-administrator' => [
                'file' => 'user/plugins/abibao-administrator/blueprints.yaml',
                'modified' => 1478727537
            ],
            'plugins/email' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.google-charts.enabled' => [
                ...
                'name' => 'plugins.google-charts.enabled',
                'validation' => 'strict'
            ],
            'plugins.shortcode-core' => [
                'form' => [
            ...
            'plugins.abibao-administrator.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.abibao-administrator.enabled',
                'validation' => 'strict'
            ],
            'plugins.abibao-administrator.uri' => [
                'type' => 'text',
                'label' => 'API gateway url to use',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.abibao-administrator.uri',
                'validation' => 'strict'
            ],
            'plugins.abibao-administrator.email' => [
                'type' => 'text',
                ...
                'name' => 'plugins.abibao-administrator.email',
                'validation' => 'strict'
            ],
            'plugins.abibao-administrator.password' => [
                'type' => 'password',
                'label' => 'API administrator password',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.abibao-administrator.password',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'form' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'google-charts' => [
                    'enabled' => 'plugins.google-charts.enabled'
                ],
                'shortcode-core' => [
                ...
                'abibao-administrator' => [
                    'enabled' => 'plugins.abibao-administrator.enabled',
                    'uri' => 'plugins.abibao-administrator.uri',
                    'email' => 'plugins.abibao-administrator.email',
                    'password' => 'plugins.abibao-administrator.password'
                ],
                'email' => [
